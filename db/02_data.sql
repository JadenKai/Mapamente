...
('Mexico City',
 ...
 'Mexico City is one of Latin America''s richest cultural centers: the Palacio Nacional houses murals by Diego Rivera chronicling Mexico''s entire history, and the Alameda Central is the oldest public park in the Americas. The historic center is a UNESCO World Heritage Site, and Chapultepec Park contains world-class museums including the National Museum of Anthropology. The city''s service sector contributes approximately 25.3% of Mexico''s national GDP — the largest share of any single region in the country. Educational institutions include UNAM, one of the largest universities in the world and itself a UNESCO World Heritage Site. Mexico City hosted the Summer Olympic Games in 1968.',
 'MexicoCityBanner.png'),

('Buenos Aires',
 'Buenos Aires was first settled by Spanish colonizer Pedro de Mendoza in 1536 and named it Nuestra Señora Santa María del Buen Aire,''Our Lady of the Good Air'', from which the city takes its name. After the original settlement failed due to indigenous resistance and food shortages, Juan de Garay permanently refounded the city in 1580. It became the seat of the Viceroyalty of the Río de la Plata in 1776, elevating it to one of the most important administrative and commercial centers in Spanish South America. Argentina declared independence in 1816, and Buenos Aires was officially made the federal capital of Argentina in 1880, ending decades of political conflict between the city and the interior provinces. From the mid-19th to early 20th century, millions of European immigrants, that were mostly Italian and Spanish, arrived through Buenos Aires, transforming its demographics and culture. The tango was born in the working-class tenements of this era in the late 1800s, blending African, European, and Cuban rhythms.',
 'Buenos Aires is the largest port in South America and home to the University of Buenos Aires (UBA), Argentina''s major national university and one of the largest in the world. Its residents are known as porteños — meaning ''people of the port.'' Greater Buenos Aires is home to about one-third of all Argentine people. The city is celebrated as the birthplace and world capital of tango. The Teatro Colón is one of the world''s great opera houses. The political movement of Peronism, associated with General Juan Perón who rose to power in 1943, drew enormous support from the city''s working-class migrants and remains a defining force in Argentine political identity.',
 'BuenosAiresBanner.png'), 

('Barcelona',
 'According to tradition, Barcelona was founded by the Phoenicians or Carthaginians, ancient seafarers who maintained trading posts along the Catalonian coast. During Roman times it was known as Barcino. The city became an important medieval mercantile power under the Counts of Barcelona before a critical turning point in 1714, during the War of the Spanish Succession: Catalans had backed a rival Habsburg claimant to the Spanish throne, and when Philip V prevailed, he besieged and captured Barcelona on September 11, 1714, suppressing Catalan institutions and imposing Castilian law, a historical wound still commemorated annually as Catalonia''s national day. The 19th-century industrial revolution made Barcelona Spain''s leading industrial city. During the Spanish Civil War (1936–39), Barcelona served as the loyalist capital of the Republican side until Franco''s forces captured it in January 1939. The city''s modern rebirth was catalyzed by hosting the 1992 Summer Olympic Games, which triggered massive urban renewal and rebranded Barcelona as a world-class destination.',
 'Barcelona is the capital of the autonomous community of Catalonia and Spain''s major Mediterranean port. The Barcelona metropolitan area provides about one-fifth of Spain''s total industrial output. The Sagrada Família basilica, designed by Antoni Gaudí and begun in 1882, is still unfinished and is the most visited monument in Spain. La Rambla is Barcelona''s iconic tree-lined pedestrian mall. FC Barcelona''s youth academy, La Masia, has produced world-class players including Lionel Messi, Xavi Hernández, and Andrés Iniesta. The club plays at Camp Nou, the largest stadium in Europe, and its fixture against Real Madrid is known as El Clásico.',
 'BarcelonaBanner.png'),
...
('Bogotá',
 ...
 'Bogotá sits 2,640 metres above sea level in the Cordillera Oriental of the Northern Andes, making it one of the highest capital cities in the world. It is widely nicknamed the Athens of South America for its concentration of universities, museums, libraries, and cultural institutions. The Gold Museum (Museo del Oro) possesses the world''s finest and largest collection of pre-Columbian worked gold, with over 55,000 pieces. Avianca, the first commercial airline in South America, founded in 1919, is headquartered in Bogotá. The city is home to bronze sculptures by Fernando Botero, Colombia''s most internationally renowned artist, known for his distinctive voluminous figurative style. Colombia is the most populous Spanish-speaking nation in South America.',
 'BogotaBanner.png'),
...
('Mérida',
 ...
 'Mérida is the capital of the state of Yucatán in southeastern Mexico and lies approximately 20 miles (30 km) south of its Gulf of Mexico port, Progreso. The city serves as the premier gateway to the ancient Maya world, with Chichén Itzá, one of the New Seven Wonders of the World, accessible as a day trip, along with the sites of Uxmal and Kabah. The Regional Museum of Anthropology, opened in 1920, exhibits Olmec and Mayan artifacts. The Autonomous University of Yucatán was founded in 1922 and is the main institution of higher learning in the region. Mérida is nicknamed ''La Ciudad Blanca'' (The White City) and is celebrated for its traditional culture, vibrant Maya-influenced cuisine, and quality of life.',
 'MeridaBanner.png'),

('Asunción',
 'Asunción was founded on August 15, 1537, on the day of the Catholic Feast of the Assumption. This is a holy day celebrating the belief that the Virgin Mary was taken up into heaven, and the city was named after this occasion. It served as the headquarters of Spanish colonial activities across eastern South America for nearly half a century before Buenos Aires was permanently refounded in 1580. In 1588, the Jesuits established mission settlements on the Paraná River near Asunción, governing approximately 150,000 Guaraní people in the famous Jesuit Reductions for over 150 years. Paraguay declared independence from Spain at midnight on May 14–15, 1811. The War of the Triple Alliance (1864–1870) pitted Paraguay against Argentina, Brazil, and Uruguay, killing an estimated half of Paraguay''s total population. General Alfredo Stroessner seized power in 1954 and ruled as a dictator until 1989, this was one of the longest dictatorships in Latin American history.',
 'Asunción is the capital and largest city of Paraguay, sitting on the Paraguay River near its confluence with the Pilcomayo River. Its Pantheon of Heroes, which were modeled after Les Invalides in Paris, is the city''s most iconic landmark and houses the remains of Paraguay''s national heroes. The Universidad Nacional de Asunción was founded in 1890 and is the largest national university in Paraguay. Guaraní was recognized as an official language of Paraguay alongside Spanish in the 1992 constitution. This made Paraguay the only country in the Americas where an indigenous language is spoken by the majority of the population. Paraguay''s economy relies heavily on agriculture, hydroelectric power (including the Itaipú Dam shared with Brazil), and a significant informal commercial sector.',
 'AsuncionBanner.png');
